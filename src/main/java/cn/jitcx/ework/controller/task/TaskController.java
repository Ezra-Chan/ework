package cn.jitcx.ework.controller.task;
...
import cn.jitcx.ework.model.dao.taskdao.TaskloggerDao;
...
import cn.jitcx.ework.services.task.TaskService;
...
public class TaskController {
	...
	public String tasklogger(Tasklogger logger, @SessionAttribute("userId") Long userId) {
		...
		logger.setUsername(userlist.getRealName());
		// 存日志
		tldao.save(logger);
		// 修改任务状态
	...
	public String updatelo(Tasklogger logger, @SessionAttribute("userId") Long userId) {
		...
		logger.setCreateTime(new Date());
		logger.setUsername(user.getRealName());
		// 存日志
		tldao.save(logger);
