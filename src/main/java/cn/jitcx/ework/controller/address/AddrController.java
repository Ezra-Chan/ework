package cn.jitcx.ework.controller.address;
...
import cn.jitcx.ework.mappers.AddressMapper;
import cn.jitcx.ework.model.dao.address.AddressDao;
import cn.jitcx.ework.model.dao.address.AddressUserDao;
import cn.jitcx.ework.model.dao.notedao.AttachService;
...
import cn.jitcx.ework.services.address.AddreddUserService;
import cn.jitcx.ework.services.address.AddressService;
...
public class AddrController {
	...
	public String outMessShow(Model model,@RequestParam("director") Long director,@SessionAttribute("userId") Long userId){
		...
		if(d.getAttachment()!=null){
			...
			model.addAttribute("imgpath", "E:/IDEA/Projects/oa_system/src/main/resources/static/images/timg.jpg");
		}
