package cn.jitcx.ework.services.inform;
...
public class InformService {
	...
	public List<Map<String, Object>> fengZhuang(List<NoticesList> noticelist) {
		...
		for (int i = 0; i < noticelist.size(); i++) {
			...
			result.put("realName", udao.findOne(noticelist.get(i).getUserId()).getRealName());
	...
	public Page<NoticesList> pageThis(int page, Long userId,String baseKey,Object status,Object time) {
		int size=10;
		List<Order> orders = new ArrayList<>();
		Pageable pa=null;
		//根据状态排序
