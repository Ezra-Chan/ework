package cn.jitcx.ework.model.entity.file;
...
public class FilePath {
	...
	private Long parentId;    //父路径id
	
	@Column(name = "path_name")
	private String pathName;     //文件夹名
	
	@Column(name = "path_istrash")
	private Long pathIstrash = 0L;   //是否是垃圾文件（放入回收站）
	
	@Column(name = "path_user_id")
	private Long pathUserId;          //文件归属用户id
