		...
		<div class="bgc-w box box-solid " style="border-top: 3px solid blue;">
			<div class="box-header ">
				...
				<ul class="list-group ">
					<li class="">
						<b>我的消息</b>
						<a href="/infromlist" class="pull-right me" >
				...
				<a href="##" class="btn btn-primary btn-block wri" data-toggle="modal" data-target="#notepaper">
					<b><i class="glyphicon glyphicon-pushpin"></i> 写便签</b>
				</a>
				<a href="##" class="btn btn-primary btn-block" data-toggle="modal" data-target="#uploadFace">
					<b><i class="glyphicon glyphicon-open"></i> 上传人脸</b>
				</a>
			</div>
		</div>
					...
					<div class="alert alert-danger alert-dismissable" style="display:none;" role="alert">
						...
						<div class="row">
							<div class="col-md-6 form-group">
								...
								<input name="realName" type="text" value="${user.realName}" readonly="readonly"
							...
							<div class="col-md-6 form-group">
								...
								<input name="userName" type="text" value="${user.userName}" id="ctl00_cphMain_txtName"
									   class="form-control" style="background-color:#fff;" onfocus="this.blur()" />
							</div>
							<div class="col-md-6 form-group">
							...
							<div class="col-md-6 form-group">
								...
								<input name="userEdu" type="text" value="${user.userEdu}"
									   id="ctl00_cphMain_txtEducation" class="form-control" />
							</div>
							<div class="col-md-6 form-group">
								<label class="control-label"><span id="ctl00_cphMain_Label7">毕业院校</span></label>
								<input name="school" type="text" value="${user.school}"
									   id="ctl00_cphMain_txtSchool" class="form-control" />
							</div>
							<div class="col-md-6 form-group">
								<label class="control-label"><span id="icard">身份证号</span></label>
								<input name="idCard" type="text" value="${user.idCard}" id="ic" class="form-control" />
							</div>
							<div class="col-md-6 form-group">
								<label class="control-label"><span id="ctl00_cphMain_Label9">银行账号</span></label>
								<input name="bank" type="text" value="${user.bank}"
									   id="ctl00_cphMain_txtBankAccount" class="form-control" />
							</div>
							<div class="col-md-6 form-group">
								<label class="control-label"><span id="ctl00_cphMain_Label16">性别</span></label>
								<select name="sex" id="ctl00_cphMain_ddlSex" class="form-control select2">
							...
							<div class="col-md-6 form-group">
								...
								<select name="themeSkin" id="ctl00_cphMain_ddlSkin" class="form-control select2">
									<option value="blue">简洁蓝</option>
									<option value="green">清新绿</option>
									<option value="red">中国红</option>
									<option value="yellow">大气黄</option>
								</select>
							</div>
							<div class="col-md-6 form-group">
								<label class="control-label"><span id="ctl00_cphMain_Label14">生日</span></label>
								<input name="birth" type="text" id="Birthday" class="form-control" readonly="readonly" style="background-color:#fff;"/>
							</div>
							<div class="col-md-6 form-group">
								<label class="control-label"><span id="ctl00_cphMain_Label13">签名</span></label>
								<input name="userSign" type="text" value="${(user.userSign)!''}"
						...
						<div class="row">
							...
							<div class="col-md-6 form-group">
								<label class="control-label">
									<span id="ctl00_cphMain_Label11">新的密码</span>
								</label>
								<input name="password" type="password" id="Password" class="form-control" />
							</div>
<#--							<div class="col-md-6 form-group">-->
<#--								<label class="control-label">-->
<#--									<span id="ctl00_cphMain_Label12">确认密码</span>-->
<#--								</label>-->
								...
								<div class="form-group">
									<div class="btn btn-default" style="position: relative; overflow: hidden;">
										<i class="glyphicon glyphicon-open"></i> 上传头像
										 <input type="file" name="filePath" style="opacity: 0; position: absolute; top: 0; right: 0; min-width: 100%; min-height: 100%;">
									</div>
...
//验证密码
function isPasswordNo(newPassword){
	var flag=true;
	var npw = $.trim(newPassword);
	if(npw.length < 6 || npw.length > 19) {
