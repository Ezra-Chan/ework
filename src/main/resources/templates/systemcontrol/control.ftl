		...
		<div class="col-md-7 gridly">
			...
			<div class="panel panel-default box-show green-box">
				<div class="panel-heading box-show-heading" style="background: white;">
					...
					<div class="pull-right right-btn-group dropdown" style="display: inline-block;">
				...
				<div id="line" class="shrink" style="min-width: 100px; height: 280px; border-top:solid 1px #eee; margin: 0 auto"></div>
			</div>
					...
					<table class="table table-hover" >
						...
						<#list noticeList as notice>
							<tr>
								...
								<td>
									<a href="informshow?id=${notice.notice_id}&read=${notice.is_read}&relationid=${notice.relatin_id}" class="look-xiangxi">
					...
					<div class="pull-right right-btn-group dropdown" style="display: inline-block;">
						<div style="display: inline-block;">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="flowmanage">我的申请</a></li>
							</ul>
						</div>
						<a >
							<button>
				...
				<div id="" class="shrink">
					<table class="table table-hover" >
						...
						<tr>
							...
							<td>
								<#list prostatuslist as pros>
									<#if pros.statusId==pro.statusId>
										<span class="label ${(pros.statusColor)!''}">
											${(pros.statusName)!''}
										</span>
									</#if>
								</#list>
							...
							<td>
								<a class="look-xiangxi" href="particular?id=${pro.processId}&typename=${(pro.typeNmae)!''}">
									<span class="glyphicon glyphicon-search"> </span> 查看
								</a>
							</td>
						</tr>
		...
		<div class="rightcolmd">
			...
			<div class="panel panel-default box-show green-box">
				<div class="panel-heading box-show-heading" style="background: white;">
					...
					<div class="pull-right right-btn-group btn-color dropdown" style="display: inline-block;">
						<div style="display: inline-block;">
							<button data-toggle="dropdown" >
								<span class="glyphicon glyphicon-menu-hamburger"></span>
							</button>
				...
				<div id="column" class="shrink" style="min-width: 100px; height: 280px; margin: 0 auto;border-top:solid 1px #eee; "></div>
			</div>
			<!--第四个格子-->
			<!-- 行事历 -->
			<div class="panel" style="background-color: #00c86c;color: white;">
				...
				<div class="shrink" style="height: 280px;padding: 10px;">
					...
					<div id="blockdiv" style="background-color: white; display: none; z-index: 999; border: 1px solid rgb(105, 103, 103); position: absolute; color: rgb(105, 103, 103);text-align: center; ">dfdfdf</div>
				</div>
			</div>
			<!--第五个格子-->
			<div class="panel panel-default box-show green-box">
				...
				<div class="shrink">
					<ul class="list-group">
						<#list  notepaperList as np>
							<li class="list-group-item list-group-item-li" style="">
								<img src="/image/${(user.imgPath)!'/timg.jpg'}" alt="photo" title="wowoowo" class="item-li-img" />
								<p class="item-li-p">
					...
					<div class="input-group input-div">
						<input type="text" placeholder="便签内容" style="outline: none;" class="concent"/>
						<a id="writep" style="cursor: pointer;">
