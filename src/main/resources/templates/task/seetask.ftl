				...
				<div class="row">
					<div class="box-body"
						...
						<div class=" mailbox-read-info">
							...
							<#if task.reciverlist??>
								<h5 class="fonts">
									...
									<span id="ctl00_cphMain_lblFrom" class="mailbox-read-time">发布人：<i>${user.realName}</i> &nbsp;&nbsp;参加人员：<i>${task.reciverlist}</i></span>
						...
						<div class="col-md-6 form-group">
							...
							<input name="loggerTicking" type="text" class="form-control" />
							<input name="taskId" type="text" id="ctl00_cphMain_txtPowerValue"
