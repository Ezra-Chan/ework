...
<div class="bgc-w box box-primary" style="height: 695px;">
	...
	<div class="box-header">
		...
		<div class="box-tools">
			<div class="input-group" style="width: 150px;">
				<input type="text" class="form-control input-sm findfileandpath" placeholder="查找..." />
				<div class="input-group-btn">
					<a class="btn btn-sm btn-default btn-change findfileandpathgo">
	...
	<div class="box-body no-padding">
		<div style="padding: 5px;">
			<a class="btn btn-sm btn-default allcheck" href="javascript:void(0);" title="全选/反选">
				<span class="iconfont icon-xuanze1"></span>
			</a>
			<div class="btn-group">
				<#if isload??>
					<#if istrash??>
			...
			<a class="btn btn-sm btn-default" href="filemanage" title="刷新">
