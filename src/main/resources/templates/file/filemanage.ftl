	...
	<div class="row" style="padding-top: 15px;">
		<div class="col-md-3">
			<form class = "fileuploadform" action="fileupload" method="post" enctype="multipart/form-data">
				<div class="btn btn-primary uploadfile" style="position: relative; overflow: hidden;width: 100%; margin-bottom: 20px;">
			...
			<div class="bgc-w box box-solid">
				...
				<ul class="nav nav-pills nav-stacked mm">
					<li class="activee filetypedocument">
						<a href="filemanage">
							<span class="iconfont icon-suoyougongneng"></span> 全部文件
						</a>
					</li>
					<li>
						<a href="##" class="filetypedocument">
							<span class="iconfont icon-icon4"></span>文档
						</a>
					</li>
					<li>
						<a href="##" class="filetypeimage">
							<span class="iconfont icon-tupian"></span>图片
						</a>
					</li>
					<li>
						<a href="##" class="filetypemusic">
							<span class="iconfont icon-yinyue"></span>音乐
						</a>
					</li>
					<li>
						<a href="##" class="filetypevedio">
							<span class="iconfont icon-shipin"></span>视频
						</a>
					</li>
					<li>
						<a href="##" class="filetypeyasuo">
							<span class="iconfont icon-yasuobao"></span>压缩包
						</a>
					</li>
					<li>
						<a href="##" class="filetypeshare">
							<span class="iconfont icon-fenxiang"></span>共享文件
						</a>
					</li>
					<li>
						<a href="##" class="filetypetrash">
							<span class="iconfont icon-lajitong"></span> 回收站
						</a>
					</li>
				</ul>
			</div>
