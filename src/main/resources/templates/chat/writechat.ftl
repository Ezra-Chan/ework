	...
	<form action="adddiscuss" method="post" enctype="multipart/form-data" onsubmit="return check();">
		<div class="box-body">
			...
			<div class="form-group addvote" style="display:none;">
				...
				<#if voteList??>
					<input name="inReceiver" type="text" id="inputtext" style="background-color: #fff;" class="form-control"  placeholder="选项" disabled="disabled"/>
				<#else>
					<input name="inReceiver" type="text" id="inputtext" style="background-color: #fff;" class="form-control"  placeholder="选项" />
				</#if>
			...
			<div class="form-group">
				<textarea name="content" placeholder="在此处填写详细内容...." class="form-control tent textareaContent" style="width: 100%; height: 360px; font-size: 20px;">${(discuss.content)!''}</textarea>
			</div>
			<!-- <div class="form-group">
