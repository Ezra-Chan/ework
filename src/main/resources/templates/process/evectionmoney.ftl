		...
		<div class="bgc-w box">
			...
			<div class="box-header">
				...
				<tr >
					...
					readonly="readonly" style="background-color:#fff;" value="${realName}"/></td>
							...
							<tbody class="tbody traffic tt">
								<tr>
									...
									<td colspan="2"><input type="text" class="form-control inpu" readonly="readonly" 
												   style="background-color:#fff;" name="traffic[0].realName"/>
											<div class="reciver">
...
//	return false;
	...
	$(function(){
		...
		$(".trazeng").click(function(){
			...
			var td2 = $('<td  colspan="2"></td>').append($('<input type="text" class="form-control inpu" readonly="readonly"  style="background-color:#fff;" name="traffic['+i+'].realName"/>'))
												 .append($('<div class="reciver"></div>').append($('<span style="color:green;" class=" glyphicon glyphicon-plus"></span>')));
