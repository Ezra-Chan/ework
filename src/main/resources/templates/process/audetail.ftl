	...
	<div class="col-md-12">
		...
		<form action="susave">
			...
			<div class="box-body">
				...
				<div class="shen">
					<p>${(list.poname)!''}：${(list.realName)!''}<span class="pull-right">${(list.retime)!''}</span></p>
					<div >
				...
				<div class="shen">
					<p>申请人：${(process.userId.realName)!''}<span class="pull-right">${(process.applyTime)!''}</span></p>
					<div >
					<div style="display:inline-block;position:absolute;">
				...
				<div class="col-md-6 form-group" style="position: relative;">
					<label class="control-label" data-toggle="modal" data-target="#myModal">下一步审核人</label>
						<input name="realName" type="text" id="recive_list"
